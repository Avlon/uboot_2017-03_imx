...
iomux_v3_cfg_t const usb_hc1_pads[] = {
	 MX6_PAD_EIM_D30__GPIO3_IO30 	| MUX_PAD_CTRL(NO_PAD_CTRL),     // USB H1 OC
	 MX6_PAD_EIM_D31__GPIO3_IO31 	| MUX_PAD_CTRL(NO_PAD_CTRL),     // USB H1 VBUS 
	 MX6_PAD_NANDF_D5__GPIO2_IO05 	| MUX_PAD_CTRL(NO_PAD_CTRL),     // HUB RESET
};
